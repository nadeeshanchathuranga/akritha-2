...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::post('/api/sales-report', [SalesReportController::class, 'fetchByDate']);
    Route::get('/bill-view', [BillViewController::class, 'index'])->name('bill-view.index');
    Route::get('/bill-view/{id}', [BillViewController::class, 'show'])->name('bill-view.show');
    Route::post('/api/bill-search', [BillViewController::class, 'search']);
